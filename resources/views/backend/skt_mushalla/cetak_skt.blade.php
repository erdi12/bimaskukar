...
<head>
    <meta charset="utf-8">
    <title>Surat Keterangan Terdaftar Mushalla</title>
    <style>
        body {
    ...
    <div class="kertas">
        ...
        <div class="isi-surat">
            ...
            <p>
                ...
                dengan <b>Nomor Identitas Mushalla : <span
                        style="font-size: 16pt;">{{ $sktMushalla->nomor_id_mushalla }}</span></b>
            </p>
            ...
            <tr>
                ...
                <td class="ttd-col-text">
                    <p>
                        ...
                        Kepala, <br><br><br><br>
                        <span style="font-weight: bold; text-decoration: underline;">${ttd_pengirim}</span> <br>
                        <br><br><br>
                        ${nama_pengirim}
                    </p>
                </td>
