...
@section('title', 'Rekap Data Masjid')
...
@section('content')
    <div class="content">
        <div class="page-title mb-4 d-flex justify-content-between align-items-center">
            <div>
                <h3 class="fw-bold">Dashboard Rekapitulasi Masjid</h3>
                <p class="text-muted mb-0">Statistik sebaran dan komposisi Masjid di Kutai Kartanegara</p>
            </div>
        ...
        <div class="row g-3 mb-4 fade-in-up">
            ...
            <div class="col-12 col-md-4 col-xl-3">
                <div class="card border-0 shadow-sm h-100 hover-card"
                    style="background: linear-gradient(135deg, #0f766e 0%, #115e59 100%); color: white; border-radius: 1rem;">
                    <div
                        ...
                        <i class="fas fa-mosque position-absolute"
                        ...
                        <h6 class="text-uppercase fw-bold letter-spacing-1 mb-1"
                            style="font-size: 0.8rem; letter-spacing: 1px; opacity: 0.9;">Total Masjid</h6>
            ...
            <div class="col-12 col-md-8 col-xl-9">
                <div class="row g-3">
                    @php
                        ...
                        $styles = [
                            ['bg' => '#dcfce7', 'text' => '#166534', 'icon' => 'fas fa-mosque'], // Green
                            ['bg' => '#dbeafe', 'text' => '#1e40af', 'icon' => 'fas fa-star'], // Blue
                            ['bg' => '#fef9c3', 'text' => '#854d0e', 'icon' => 'fas fa-landmark'], // Yellow
                            ['bg' => '#fee2e2', 'text' => '#991b1b', 'icon' => 'fas fa-history'], // Red
                            ['bg' => '#f3e8ff', 'text' => '#6b21a8', 'icon' => 'fas fa-building'], // Purple
                            ['bg' => '#ffedd5', 'text' => '#9a3412', 'icon' => 'fas fa-city'], // Orange
                        ];
                    @endphp
                ...
                <div class="card border-0 shadow-sm h-100 hover-card" style="border-radius: 1rem;">
                    <div class="card-header border-bottom-0 py-3 d-flex justify-content-between align-items-center"
                        ...
                        <button class="btn btn-sm btn-light rounded-circle"
                            onclick="downloadChart('kecamatanChart', 'Sebaran_Masjid.png')" title="Download Grafik">
            ...
            <div class="col-12 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-card" style="border-radius: 1rem;">
                    <div class="card-header border-bottom-0 py-3 d-flex justify-content-between align-items-center"
                        ...
                        <button class="btn btn-sm btn-light rounded-circle"
                            onclick="downloadChart('tipologiChart', 'Tipologi_Masjid.png')" title="Download Grafik">
                            <i class="fas fa-download text-secondary"></i>
                        </button>
                    </div>
        ...
        <div class="card border-0 shadow-sm fade-in-up" style="border-radius: 1rem; animation-delay: 0.2s;">
            <div class="card-header border-bottom-0 py-3 d-flex justify-content-between align-items-center"
                ...
                <button class="btn btn-sm btn-success rounded-pill px-3"
                    onclick="downloadTable('tableRekap', 'Rekap_Data_Masjid')" title="Download Excel">
                    <i class="fas fa-file-excel me-2"></i> Download Excel
                </button>
            </div>
            <div class="card-body p-0 table-responsive">
                <table id="tableRekap" class="table table-hover align-middle mb-0" style="width:100%">
                        ...
                        @foreach ($rekap as $index => $row)
                            <tr>
                                ...
                                <td class="text-center">
                                    <span
                                        class="badge bg-primary bg-opacity-10 text-primary rounded-pill px-3">{{ $row->total }}</span>
                                </td>
                                @foreach ($tipologis as $t)
                    ...
                    <tfoot class="bg-light fw-bold">
                        <tr>
                            ...
                            <td class="text-center text-primary py-3">
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Soft Modern Colors
            const colors = [
                '#0d9488', '#0ea5e9', '#8b5cf6', '#ec4899', '#f59e0b', '#84cc16'
            ];
            ...
            const barChart = new Chart(ctxBar, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Jumlah Masjid',
                        data: totalData,
                        backgroundColor: '#2d7a2d', // Simtak Hijau Utama
                        borderRadius: 6,
                        barPercentage: 0.6
                    }]
                },
