                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" method="POST"
                                    action="{{ route('skt_piagam_mt.update', $sktpiagammt->id) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-6">
                                            <div class="form-group">
                                                ...
                                                <input readonly type="text" id="nomor_statistik"
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6 col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="nama_majelis"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="alamat">Alamat Majelis Ta'lim (Tanpa Kelurahan dan
                                                    Kecamatan)</label>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select @error('kecamatan_id') is-invalid @enderror"
                                                    id="kecamatan" name="kecamatan_id" style="width: 100%;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="tanggal-berdiri"
                                                    class="form-control datepicker @error('tanggal_berdiri') is-invalid @enderror"
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="ketua"
                                                    class="form-control @error('ketua') is-invalid @enderror" name="ketua"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="mendaftar"
                                                    class="form-control datepicker @error('mendaftar') is-invalid @enderror"
                                                    name="mendaftar"
                                                    value="{{ old('mendaftar', $sktpiagammt->mendaftar) }}"
                                                    placeholder="Pilih Tanggal">
                                                @error('mendaftar')
                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="mendaftar_ulang"
                                                    class="form-control datepicker @error('mendaftar_ulang') is-invalid @enderror"
