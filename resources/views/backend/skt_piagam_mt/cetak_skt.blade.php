...
<head>
    ...
    <style>
        ...
        .kop-text {
            margin-left: -25px;
            /* Beri jarak dari logo yang di-float */
            text-align: center;
        }
...
<body>
    <div class="kertas">
        ...
        <div class="kop-surat-container">
            ...
            <div class="kop-text">
                <p style="font-size: 14pt;">KEMENTERIAN AGAMA REPUBLIK INDONESIA</p>
                ...
                <p style="font-size: 9pt;">
                    ...
                    Website : <a href="https://kemenagkutai.kaltimprov.go.id">https://kemenagkutai.kaltimprov.go.id</a>
                </p>
            </div>
        </div>
        ...
        <div class="isi-surat">
            ...
            <div class="data-row">
                ...
                <div class="data-isi">
                    ...
                    {{ $sktpiagammt->kelurahan->nama_kelurahan }}, Kec.
                    {{ ucwords($sktpiagammt->kecamatan->kecamatan) }}
                </div>
            </div>
            ...
            <p>
                ...
                dengan <b>Nomor Identitas Statistik : <span
                        style="font-size: 16pt;">{{ $sktpiagammt->nomor_statistik }}</span></b>
            </p>
