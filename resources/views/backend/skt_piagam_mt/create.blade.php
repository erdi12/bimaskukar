                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="nomor_statistik"
                                                        ...
                                                        name="nomor_statistik" readonly required
                                                        value="{{ old('nomor_statistik') }}">
                                                ...
                                                @enderror
                                                <small class="text-muted">Nomor statistik akan otomatis terisi setelah
                                                    memilih kecamatan</small>
                                    ...
                                    <div class="row">
                                                ...
                                                <select class="form-select" id="kecamatan" name="kecamatan_id"
                                                    ...
                                                    @foreach ($kecamatans as $kecamatan)
                                                        <option value="{{ $kecamatan->id }}"
                                                            ...
                                                            {{ ucwords($kecamatan->kecamatan) }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" id="kelurahan" name="kelurahan_id"
                                                    style="width: 100%;" required>
                                                ...
                                                <fieldset class="form-group">
                                                    <select class="form-select" id="status" name="status" required>
                                                        ...
                                                        <option value="belum_update"
                                                            {{ old('status') == 'nonaktif' ? 'selected' : '' }}>Belum
                                                            Update</option>
                                                    </select>
                                                </fieldset>
                                            </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="no_hp" class="form-control"
                                                    placeholder="Nomor Handphone Ketua Majelis Ta'lim" name="no_hp"
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="mendaftar_ulang"
                                                    class="form-control datepicker" name="mendaftar_ulang" required
                                                    value="{{ old('mendaftar_ulang') }}" placeholder="Pilih Tanggal">
                                            </div>
                                        </div>
                                    </div>
            ...
            $(document).ready(function() {
                ...
                $('#kecamatan').on('change', function() {
                    ...
                    if (kecamatanId) {
                        // Ambil kelurahan
                        $.ajax({
                            url: "{{ url('api/kelurahans') }}/" + kecamatanId,
                            type: "GET",
                            dataType: 'json',
