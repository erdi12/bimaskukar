...
<body>
    <div class="login-container">
        <div class="login-info">
            <div class="login-info-content">
                <div class="islamic-pattern">
                    <img src="{{ asset('voler/assets/images/logo-bimas.svg') }}" class="img-fluid" alt=""
                        srcset="">
                </div>
                <h1 class="d-flex justify-content-center text-center">S I B E R K A T</h1>
                <h3 class="d-flex justify-content-center text-center login-description">Sistem Informasi Bimas Islam
                    Kutai Kartanegara Berbasis Digital</h3>


                <div class="islamic-quote">
                    <p>"Dan hendaklah ada di antara kamu segolongan umat yang menyeru kepada kebaikan, menyuruh kepada
                        yang ma'ruf, dan mencegah dari yang mungkar; dan mereka itulah orang-orang yang beruntung."</p>
        ...
        <div class="login-form">
            ...
            <p class="login-description">Silakan masuk untuk mengakses dashboard SIBERKAT</p>
