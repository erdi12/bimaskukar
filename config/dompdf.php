...
return [
    ...
    */
    ...
    'options' => [
        ...
        'font_family' => [
            'imprint' => [
                'normal' => public_path('fonts/imprint-mt-shadow.ttf'),
                'bold' => public_path('fonts/imprint-mt-shadow.ttf'),
                'italic' => public_path('fonts/imprint-mt-shadow.ttf'),
                'bold_italic' => public_path('fonts/imprint-mt-shadow.ttf'),
            ],
        ],
